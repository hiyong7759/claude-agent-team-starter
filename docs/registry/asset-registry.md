...
dependencies:
  - path: ../rules/hard-rules.md
    reason: Traceability rules reference
...
For practical flow, see `docs/rules/hard-rules.md` (traceability section).
...
| CAP-005 | Glossary Maintenance | EO | All work | `docs/rules/glossary.md` | v1.0 | Stable |
| CAP-006 | Execution Policy | EO | All work | `docs/rules/execution-rules.md` | v1.0 | Stable |
| CAP-007 | Quality Gates | EO | All work | `docs/rules/quality-gates-rules.md` | v1.0 | Stable |
| CAP-008 | Reuse-first Decision | MA | All change work | `docs/rules/hard-rules.md` | v1.0 | Stable |
| CAP-009 | Domain Fit Gate | PS/SA | When judging reuse | `docs/rules/workflow-rules.md` | v1.0 | Stable |
| CAP-010 | Secrets Management | PG | When handling sensitive information | `docs/rules/security-rules.md` | v1.0 | Stable |
| CAP-011 | Version/Deprecation Management | EO | When changing assets | `docs/rules/execution-rules.md` | v1.0 | Stable |
| CAP-012 | Golden Set Operation | RE | During regression testing | `docs/rules/test-rules.md` | v1.0 | Stable |
| CAP-013 | Project Onboarding | MA | When starting project | `docs/rules/workflow-rules.md` | v1.0 | Stable |
| CAP-014 | Agent Evaluation Operation | RE | All work (especially MEDIUM/HIGH) | `docs/rules/test-rules.md` | v1.0 | Stable |
| CAP-015 | Phase 2+ Reserved Policy | EO | Operational metrics/backup/release/log/remote request definition | `docs/rules/execution-rules.md` | v0.5 | Draft |
| CAP-016 | Runbook/Postmortem Operation | RE | During incident/accident response | `docs/rules/workflow-rules.md` | v0.5 | Draft |
| CAP-019 | Access Control Operation | PG | When authority/approval needed | `docs/rules/security-rules.md` | v0.5 | Draft |
| CAP-022 | Request Intake | MA | All work (starting point) | `docs/rules/workflow-rules.md` | v0.5 | Draft |
...
| :---------- | :------------------------ | :------------- | :---------------------------------------------------- | :------- | :----------------------------------------------- | :-------- | :--- | ------ |
| AST-POL-001 | Reuse-first Process | System(Global) | Reuse/change management procedure | EO | `docs/rules/hard-rules.md` | All work | v1.0 | Stable |
| AST-POL-002 | Agent Plan | System(Global) | Overall design/roadmap | EO | `docs/rules/workflow-rules.md` | All actors | v1.0 | Living |
| AST-POL-003 | Traceability Guide | System(Global) | WI/ADR/Asset linking rules | EO | `docs/rules/hard-rules.md` | All work | v1.0 | Stable |
| AST-POL-004 | Scope & Domain Model | System(Global) | Project↔system scope/domain gate | SA/PS | `docs/rules/workflow-rules.md` | MA/SA/PS | v1.0 | Stable |
| AST-POL-005 | Template Governance | System(Global) | Template proliferation prevention/reuse principle | EO | `docs/rules/execution-rules.md` | All work | v1.0 | Stable |
| AST-POL-006 | Glossary | System(Global) | Common glossary (synonym/forbidden term management) | EO | `docs/rules/glossary.md` | All work | v1.0 | Stable |
| AST-POL-007 | Glossary Sources | System(Global) | Terminology standard source link/verification date management | EO | `docs/rules/glossary.md` | All work | v1.0 | Stable |
| AST-POL-008 | Execution Policy | System(Global) | Explanation+approval before complex command/tool execution | EO | `docs/rules/execution-rules.md` | All work | v1.0 | Stable |
| AST-POL-009 | Quality Gates | System(Global) | Operational quality gates by criticality | EO | `docs/rules/quality-gates-rules.md` | All work | v1.0 | Stable |
| AST-POL-011 | Versioning & Deprecation | System(Global) | Version/release/deprecation operational rules | EO | `docs/rules/execution-rules.md` | All work | v1.0 | Stable |
| AST-POL-012 | Secrets & Privacy Policy | System(Global) | Secret/sensitive information handling policy | PG | `docs/rules/security-rules.md` | All work | v1.0 | Stable |
| AST-POL-013 | Eval Golden Set | System(Global) | Eval/regression (golden set) criteria | RE | `docs/rules/test-rules.md` | All work | v1.0 | Stable |
| AST-POL-014 | Project Onboarding | System(Global) | Project startup checklist | MA | `docs/rules/workflow-rules.md` | All work | v1.0 | Stable |
| AST-POL-015 | Agent Evaluation | System(Global) | Agent activity evaluation (improvement/regression prevention) | RE | `docs/rules/test-rules.md` | All work | v1.0 | Stable |
| AST-POL-016 | Future Policy Stubs | System(Global) | Observability/Backup/Release/log/remote request definition (Phase 2+ implementation reserved) | EO | `docs/rules/execution-rules.md` | All work | v0.5 | Draft |
| AST-POL-017 | Runbook & Postmortem | System(Global) | Runbook/postmortem operational definition (lower priority implementation) | RE | `docs/rules/workflow-rules.md` | All work | v0.5 | Draft |
| AST-POL-020 | Access Control Policy | System(Global) | Access control/approval/least privilege principle (lower priority implementation) | PG | `docs/rules/security-rules.md` | All work | v0.5 | Draft |
...
- [Hard Rules](../rules/hard-rules.md): Core constraints, traceability, reuse-first

### Reference Documents

- [Workflow Rules](../rules/workflow-rules.md): MA workflow, onboarding, incident response
